...
public class ExecutableClassSinglyLinkedList {
    ...
    public static void addObject() {
        ...
        System.out.println("This is the passed in index" + index);
    ...
    public static void showAddMenu(){
        ...
        System.out.println("    3. Add a bag at a index. ");
        System.out.println("----------------------------------------------------------");
    }
    ...
    public static void showDeleteMenu(){
        ...
        System.out.println("    3. Delete a bag at a index. ");
        System.out.println("----------------------------------------------------------");
    }
